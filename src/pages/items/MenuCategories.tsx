...
import { Plus, Search, Pencil, Trash2, GripVertical, Grid3x3, X, ChevronUp } from "lucide-react";
        ...
        <Card className="shadow-sm border-primary/30 bg-primary/[0.02]">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5"><Label>Display Order</Label><Input placeholder="0" type="number" value={form.displayOrder || ""} onChange={(e) => setForm((p) => ({ ...p, displayOrder: Number(e.target.value) }))} /></div>
            </div>

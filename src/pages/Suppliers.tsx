...
const Suppliers = () => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader icon={<Truck className="h-5 w-5" />} title="Suppliers" subtitle="Manage your suppliers" actions={<Button className="gradient-primary text-primary-foreground" onClick={openAdd}><Plus className="h-4 w-4 mr-2" />Add Supplier</Button>} />

...
const breadcrumbConfig: Record<string, { label: string; parent?: { label: string; url: string } }> = {
  ...
  "/settings/self-order": { label: "Self Order", parent: { label: "Settings", url: "/settings" } },
  "/settings/website-order": { label: "Website Order", parent: { label: "Settings", url: "/settings" } },
  "/settings/reservations": { label: "Reservations", parent: { label: "Settings", url: "/settings" } },
  ...
  "/customer-dues": { label: "Customer Dues" },
